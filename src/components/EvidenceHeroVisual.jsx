  ...
  return (
    <div className="eh-visual" aria-hidden="true">
      ...
      <div className="eh-core">
        ...
        {/* shield protecting the evidence document */}
        <div className="eh-shield">
          <svg className="eh-shield-svg" viewBox="0 0 150 172">
            <defs>
              <linearGradient id="ehShield" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0" stopColor="#6fd6f5" />
                <stop offset="1" stopColor="#1f7fc0" />
              </linearGradient>
            </defs>
            <path
              d="M75 6 L135 28 V86 C135 128 108 152 75 166 C42 152 15 128 15 86 V28 Z"
              fill="rgba(9,16,42,0.72)"
              stroke="url(#ehShield)"
              strokeWidth="3"
            />
          </svg>
          <div className="eh-doc">
            <span className="eh-doc-seal"><i className="bi bi-file-earmark-lock2" /></span>
